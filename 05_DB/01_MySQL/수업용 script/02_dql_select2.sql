...
select menu_name, menu_price, if(menu_price < 10000, '싸다', '비싸다') as '가격 평가'
from tbl_menu;
...
select truncate(avg(menu_price), 0)
from tbl_menu;
...
from tbl_menu left join tbl_category using (category_code)
